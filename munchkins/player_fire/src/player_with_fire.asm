...
player_with_fire_demo:
  ...
  xor a
  ld (fire_active), a      ; Bullet starts inactive
  ei
...
ld a, 1
  ...
  ld (fire_active), a        ; Set bullet active flag
...
.update_fire_logic:
  ...
  ld a, (fire_x)
  add a, 4                   ; Speed: 4 pixels per frame
  ld (fire_x), a
...
.despawn_bullet:
  xor a
  ld (fire_active), a        ; Turn off bullet
  ld a, 5
